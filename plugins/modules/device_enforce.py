...
extends_documentation_fragment:
  - extreme_community.xiqse.fragments.OPTIONS_IPADDRESS
...
def run_module():
    ...
    query   = XIQSE.mutation.network_enforceAllDevices()
    ...
    try:
        ...
        status = result.get("data", {}).get("network", {}).get("configureDevice", {}).get("status", "ERROR")
